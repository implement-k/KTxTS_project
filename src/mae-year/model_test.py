...
def test_model(model_path=None, use_self_loop_predictor=False, use_lgbm_self_loop=False, year='2023', mode = 'val'):
    ...
    model = ODMAE(num_features=F, use_self_loop_predictor=use_self_loop_predictor).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_self_loop_predictor', type=str, default='False')
    parser.add_argument('--use_lgbm_self_loop', type=str, default='True')
    parser.add_argument('--year', type=str, default='2023', help='평가할 연도 (기본: 2023)')
    parser.add_argument('--mode', type=str, default='val', help='평가 모드 (기본: val)', choices=['test', 'val'])
